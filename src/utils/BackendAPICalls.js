...
export const getProfile = async (values) => {
    try {
        ...
        if(response?.data) {
            ...
            Alert.alert(`Something went wrong while getProfile! Please try again later.`);
        }
    } catch (error) {
...
export const updateProfile = async (data) => {
    try {
        ...
        if(response) {
            ...
            Alert.alert(`Something went wrong while updateProfile! Please try again later.`);
        }
    } catch (error) {
...
export const getServices = async (values) => {
    try {
        ...
        if(response?.data) {
            ...
            Alert.alert(`Something went wrong while getServices! Please try again later.`);
        }
    } catch (error) {
...
export const updateService = async (id, data) => {
    try {
        ...
        if(response?.data) {
            ...
            Alert.alert(`Something went wrong while updateService! Please try again later.`);
        }
    } catch (error) {
...
export const addService = async (data) => {
    try {
        ...
        if(response) {
            ...
            Alert.alert(`Something went wrong while addService! Please try again later.`);
        }
    } catch (error) {
...
export const deleteService = async (id) => {
    try {
        ...
        if(response?.data) {
            ...
            Alert.alert(`Something went wrong while deleteService! Please try again later.`);
        }
    } catch (error) {
